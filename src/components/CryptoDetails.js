...
const CryptoDetails = () => {
	...
	return (
		<Col className="coin-detail-container">
			...
			<LineChart coinHistory={coinHistory} price={cryptoDetails.price} coinName={cryptoDetails.name}/>
			<Col className="stats-container">
				<Col className="coin-value-statistics">
					<Col className="coin-value-statistics-heading">
						...
						<p>
							An overview shows stats of {cryptoDetails.name}
						</p>
					</Col>
				...
				<Col className="other-stats-info">
					<Col className="coin-value-statistics-heading">
						...
						<p>
							An overview shows stats of all cryptocurrencies
						</p>
					</Col>
